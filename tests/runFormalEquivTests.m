...
if strcmp(runTestsDialogResult,'Yes')
    f = msgbox(["Tests will commence in 6 seconds.","Please ignore any windows that pop up until testing has completed.","Results will appear in the MATLAB Command Window."]);
    pause(6)
    close(f)
    clear f
    disp("Running tests...")
